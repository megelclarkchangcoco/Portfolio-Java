...
public class MyPortfolioFrame extends JFrame implements Scrollpane, Home, Aboutme, WorkExperience, Contact {
	//========================= All IMAGE=================================
	...
	private ImageIcon xicons = new ImageIcon(
	...
	// add the about me panel
	 addAboutMePanel();
			    
	// add the work experience panel
	addWorkExperiencePanel();
			    
	// add the contact panel
	addContactPanel();
	...
	HomePanel2.setBounds(242, 22, 197, 58);
    ...
    public void addHomePanel() {   
		...
		JLabel astronuts = new JLabel("");
		astronuts.setIcon(astronaut);
		astronuts.setBounds(793, 217, 300, 350);// 325 378
